...
interface NewSkillCategorySectionProps {
  state: IState
}

const NewSkillCategorySection: React.FC<NewSkillCategorySectionProps> = (
  props: NewSkillCategorySectionProps
) => {
  ...
  return (
    ...
    >
      <Head>
        <title>New Skill Category | Dashboard</title>
      </Head>
...
export default withAuth(NewSkillCategorySection)
