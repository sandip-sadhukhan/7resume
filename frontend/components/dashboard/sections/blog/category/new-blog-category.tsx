...
interface NewBlogCategorySectionProps {
  state: IState
}

const NewBlogCategorySection: React.FC<NewBlogCategorySectionProps> = (
  props: NewBlogCategorySectionProps
) => {
...
export default withAuth(NewBlogCategorySection)
